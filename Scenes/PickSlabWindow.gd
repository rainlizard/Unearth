...
onready var tabs = {
	Slabs.TAB_MAINSLAB: [oSlabTabs.get_node("TabFolder/MainSlabs/ScrollContainer/GridContainer"), "res://images_slabs/icon_slab1.png"], #"res://images_objects/spellbooks/crspell_64/dig_std.png"
	Slabs.TAB_OTHER: [oSlabTabs.get_node("TabFolder/WallSlabs/ScrollContainer/GridContainer"), "res://images_slabs/icon_slab2.png"], #"res://images_objects/spellbooks/crspell_64/dig_dis.png"
	Slabs.TAB_CUSTOM: [oSlabTabs.get_node("TabFolder/CustomSlabsTab/ScrollContainer/GridContainer"), "res://images_slabs/icon_slab2.png"],
	Slabs.TAB_STYLE: [oSlabTabs.get_node("TabFolder/SlabStyle/ScrollContainer/GridContainer"), "res://images_effects/magic_dust/anim0978/r1frame06.png"],
	Slabs.TAB_OWNER: [oSlabTabs.get_node("TabFolder/OnlyOwnership/ScrollContainer/GridContainer"), "res://images_objects/furniture/flagpole_redflag_fp/r1frame05.png"],
	Slabs.TAB_NONE: [null, ""],
}
