...
003 : ["Gold Pot (500)", preload("res://dk_images/valuables/gold_pot_tp/AnimGoldPot.tres"), null, TAB_GOLD],
004 : ["Lit Statue", preload("res://dk_images/statues/anim0952/AnimLitStatue.tres"), null, TAB_DECORATION], #TAB_FURNITURE
005 : ["Dungeon Heart", preload("res://dk_images/crucials/anim0950/AnimDungeonHeart.tres"), null, TAB_FURNITURE],
006 : ["Gold Pot (250)", preload("res://dk_images/valuables/gold_pot_tp/AnimGoldPot.tres"), null, TAB_GOLD],
007 : ["Unlit Torch", preload("res://dk_images/other/anim0963/r1frame01.png"), null, TAB_DECORATION], #TAB_FURNITURE
008 : ["Glowing Statue", preload("res://dk_images/statues/anim0952/AnimLitStatue.tres"), null, TAB_DECORATION], #Lit Statue No Flame # Partially Lit Statue
009 : ["Egg Growing (1)", preload("res://dk_images/food/anim0898/AnimEggGrowing1.tres"), null, TAB_MISC],
010 : ["Chicken", preload("res://dk_images/food/anim0822/AnimChicken.tres"), null, TAB_MISC],
...
031 : ["Training Post", preload("res://dk_images/furniture/training_machine_tp/AnimTrainingMachine.tres"), null, TAB_FURNITURE],
032 : ["Torture Spike", preload("res://dk_images/furniture/anim0892/AnimSpike.tres"), null, TAB_FURNITURE],
033 : ["Temple Spangle", preload("res://dk_images/magic_fogs/anim0798/AnimTempleSpangle.tres"), null, TAB_DECORATION],
...
037 : ["Power Hand", preload("res://dk_images/power_hand/anim0783/AnimePowerHand.tres"), null, TAB_MISC],
038 : ["Power Hand Grab", preload("res://dk_images/power_hand/anim0784/AnimePowerHandGrab.tres"), null, TAB_MISC],
039 : ["Power Hand Whip", preload("res://dk_images/power_hand/anim0786/AnimePowerHandWhip.tres"), null, TAB_MISC],
040 : ["Egg Stable (2)", preload("res://dk_images/food/anim0899/r1frame01.png"), null, TAB_MISC],
041 : ["Egg Wobbling (3)", preload("res://dk_images/food/anim0900/AnimEggWobbling3.tres"), null, TAB_MISC],
042 : ["Egg Cracking (4)", preload("res://dk_images/food/anim0901/AnimEggCracking4.tres"), null, TAB_MISC],
043 : ["Gold Pile (200)", preload("res://dk_images/valuables/gold_hoard1_tp/AnimGoldHoard1.tres"), null, TAB_GOLD],
044 : ["Spinning Key", preload("res://dk_images/traps_doors/anim0811/AnimSpinningKey.tres"), null, TAB_MISC],
...
049 : ["Hero Gate", preload("res://dk_images/crucials/anim0780/AnimHeroGate.tres"), null, TAB_ACTION],
050 : ["Spinning Key 2", preload("res://dk_images/traps_doors/anim0811/AnimSpinningKey.tres"), null, TAB_MISC],
051 : ["Armour Effect", null, null, TAB_MISC],
052 : ["Treasury Gold 1 (800)", preload("res://dk_images/valuables/gold_hoard1_tp/AnimGoldHoard1.tres"), null, TAB_GOLD],
053 : ["Treasury Gold 2 (1200)", preload("res://dk_images/valuables/gold_hoard2_tp/AnimGoldHoard2.tres"), null, TAB_GOLD],
054 : ["Treasury Gold 3 (1600)", preload("res://dk_images/valuables/gold_hoard3_tp/AnimGoldHoard3.tres"), null, TAB_GOLD],
055 : ["Treasury Gold 4 (2000)", preload("res://dk_images/valuables/gold_hoard4_tp/AnimGoldHoard4.tres"), null, TAB_GOLD],
056 : ["Treasury Gold 5 (2400)", preload("res://dk_images/valuables/gold_hoard5_tp/AnimGoldHoard5.tres"), null, TAB_GOLD],
057 : ["Lair: Wizard", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
058 : ["Lair: Barbarian", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
059 : ["Lair: Archer", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
060 : ["Lair: Monk", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
061 : ["Lair: Dwarf", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
062 : ["Lair: Knight", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
063 : ["Lair: Avatar", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
064 : ["Lair: Tunneller", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
065 : ["Lair: Witch", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
066 : ["Lair: Giant", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
067 : ["Lair: Fairy", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
068 : ["Lair: Thief", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
069 : ["Lair: Samurai", preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.tres"), null, TAB_LAIR],
070 : ["Lair: Horny", preload("res://edited_images/lair/creature_horny/anim0160/AnimLairHornedReaper.tres"), null, TAB_LAIR],
071 : ["Lair: Skeleton", preload("res://edited_images/lair/creature_skeleton/anim0158/AnimLairSkeleton.tres"), null, TAB_LAIR],
072 : ["Lair: Troll", preload("res://edited_images/lair/creature_generic/anim0156/r1frame01.png"), null, TAB_LAIR],
073 : ["Lair: Dragon", preload("res://edited_images/lair/creature_dragon/anim0154/AnimLairDragon.tres"), null, TAB_LAIR],
074 : ["Lair: Demon Spawn", preload("res://edited_images/lair/creature_demonspawn/lairempty_tp/r1frame01.png"), null, TAB_LAIR],
075 : ["Lair: Fly", preload("res://edited_images/lair/creature_fly/anim0150/AnimLairFly.tres"), null, TAB_LAIR],
076 : ["Lair: Mistress", preload("res://edited_images/lair/creature_dkmistress/anim0148/AnimLairMistress.tres"), null, TAB_LAIR],
077 : ["Lair: Warlock", preload("res://edited_images/lair/creature_warlock/anim0146/AnimLairWarlock.tres"), null, TAB_LAIR],
078 : ["Lair: Bile Demon", preload("res://edited_images/lair/creature_biledemon/anim0144/AnimLairBileDemon.tres"), null, TAB_LAIR],
079 : ["Lair: Imp", preload("res://edited_images/lair/creature_dragon/anim0154/r1frame01.png"), null, TAB_LAIR],
080 : ["Lair: Beetle", preload("res://edited_images/lair/creature_bug/anim0142/AnimLairBeetle.tres"), null, TAB_LAIR],
081 : ["Lair: Vampire", preload("res://edited_images/lair/creature_vampire/anim0140/r1frame01.png"), null, TAB_LAIR],
082 : ["Lair: Spider", preload("res://edited_images/lair/creature_spider/anim0138/AnimLairSpider.tres"), null, TAB_LAIR],
...
094 : ["Box: Boulder Trap", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
095 : ["Box: Alarm Trap", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
096 : ["Box: Poison Gas Trap", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
097 : ["Box: Lightning Trap", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
098 : ["Box: Word of Power Trap", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
099 : ["Box: Lava Trap", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
100 : ["Box: Dummy Trap 2", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
101 : ["Box: Dummy Trap 3", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
102 : ["Box: Dummy Trap 4", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
103 : ["Box: Dummy Trap 5", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
104 : ["Box: Dummy Trap 6", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
105 : ["Box: Dummy Trap 7", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
106 : ["Box: Wooden Door", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
107 : ["Box: Braced Door", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
108 : ["Box: Iron Door", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
109 : ["Box: Magic Door", preload("res://dk_images/traps_doors/anim0116/AnimBox.tres"), null, TAB_BOX],
110 : ["Workshop Item", preload("res://dk_images/furniture/workshop_anvil_tp/r1frame01.png"), null, TAB_MISC],
111 : ["Red Heart Flame", preload("res://dk_images/magic_fogs/anim0801/AnimRedHeartFlame.tres"), null, TAB_FURNITURE],
112 : ["Disease Effect", null, null, TAB_MISC],
113 : ["Scavenger Eye", preload("res://dk_images/furniture/scavenge_eye_tp/AnimScavengerEye.tres"), null, TAB_FURNITURE],
114 : ["Workshop Machine", preload("res://dk_images/furniture/workshop_machine_tp/AnimWorkshopMachine.tres"), null, TAB_FURNITURE],
115 : ["Red Flag", preload("res://dk_images/furniture/flagpole_redflag_tp/AnimFlagpoleRed.tres"), null, TAB_FURNITURE],
116 : ["Blue Flag", preload("res://dk_images/furniture/flagpole_blueflag_tp/AnimFlagpoleBlue.tres"), null, TAB_FURNITURE],
117 : ["Green Flag", preload("res://dk_images/furniture/flagpole_greenflag_tp/AnimFlagpoleGreen.tres"), null, TAB_FURNITURE],
118 : ["Yellow Flag", preload("res://dk_images/furniture/flagpole_yellowflag_tp/AnimFlagpoleYellow.tres"), null, TAB_FURNITURE],
119 : ["Flagpole", preload("res://dk_images/furniture/flagpole_empty_tp/r1frame01.png"), null, TAB_FURNITURE],
120 : ["Blue Heart Flame", preload("res://dk_images/magic_fogs/anim0802/AnimBlueHeartFlame.tres"), null, TAB_FURNITURE],
121 : ["Green Heart Flame", preload("res://dk_images/magic_fogs/anim0800/AnimGreenHeartFlame.tres"), null, TAB_FURNITURE],
122 : ["Yellow Heart Flame", preload("res://dk_images/magic_fogs/anim0799/AnimYellowHeartFlame.tres"), null, TAB_FURNITURE],
123 : ["Casted Sight", preload("res://dk_images/magic_fogs/anim0854/AnimCastedSight.tres"), null, TAB_MISC],
...
127 : ["Power Hand Gold", preload("res://dk_images/power_hand/anim0782/AnimePowerHandGold.tres"), null, TAB_MISC],
