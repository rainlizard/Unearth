...
004 : ["Lit Statue", null,null, preload("res://dk_images/statues/anim0952/AnimLitStatue.res"), null, TAB_DECORATION], #TAB_FURNITURE
005 : ["Dungeon Heart", null,null, preload("res://dk_images/crucials/anim0950/AnimDungeonHeart.res"), null, TAB_FURNITURE],
006 : ["Gold Pot (250)", null,null, preload("res://dk_images/valuables/gold_pot_tp/AnimGoldPot.res"), null, TAB_GOLD],
007 : ["Unlit Torch", null,null, preload("res://dk_images/other/anim0963/r1frame01.png"), null, TAB_DECORATION], #TAB_FURNITURE
008 : ["Glowing Statue", null,null, preload("res://dk_images/statues/anim0952/AnimLitStatue.res"), null, TAB_DECORATION], #Lit Statue No Flame # Partially Lit Statue
009 : ["Egg Growing (1)", null,null, preload("res://dk_images/food/anim0898/AnimEggGrowing1.res"), null, TAB_MISC],
010 : ["Chicken", null,null, preload("res://dk_images/food/anim0822/AnimChicken.res"), null, TAB_MISC],
...
031 : ["Training Post", null,null, preload("res://dk_images/furniture/training_machine_tp/AnimTrainingMachine.res"), null, TAB_FURNITURE],
032 : ["Torture Spike", null,null, preload("res://dk_images/furniture/anim0892/AnimSpike.res"), null, TAB_FURNITURE],
033 : ["Temple Spangle", null,null, preload("res://dk_images/magic_fogs/anim0798/AnimTempleSpangle.res"), null, TAB_DECORATION],
...
037 : ["Power Hand", null,null, preload("res://dk_images/power_hand/anim0783/AnimePowerHand.res"), null, TAB_MISC],
038 : ["Power Hand Grab", null,null, preload("res://dk_images/power_hand/anim0784/AnimePowerHandGrab.res"), null, TAB_MISC],
039 : ["Power Hand Whip", null,null, preload("res://dk_images/power_hand/anim0786/AnimePowerHandWhip.res"), null, TAB_MISC],
040 : ["Egg Stable (2)", null,null, preload("res://dk_images/food/anim0899/r1frame01.png"), null, TAB_MISC],
041 : ["Egg Wobbling (3)", null,null, preload("res://dk_images/food/anim0900/AnimEggWobbling3.res"), null, TAB_MISC],
042 : ["Egg Cracking (4)", null,null, preload("res://dk_images/food/anim0901/AnimEggCracking4.res"), null, TAB_MISC],
043 : ["Gold Pile (200)", null,null, preload("res://dk_images/valuables/gold_hoard1_tp/AnimGoldHoard1.res"), null, TAB_GOLD],
044 : ["Spinning Key", null,null, preload("res://dk_images/traps_doors/anim0811/AnimSpinningKey.res"), null, TAB_MISC],
...
059 : ["Lair: Archer", null,null, preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.res"), null, TAB_LAIR],
060 : ["Lair: Monk", null,null, preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.res"), null, TAB_LAIR],
061 : ["Lair: Dwarf", null,null, preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.res"), null, TAB_LAIR],
062 : ["Lair: Knight", null,null, preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.res"), null, TAB_LAIR],
063 : ["Lair: Avatar", null,null, preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.res"), null, TAB_LAIR],
064 : ["Lair: Tunneller", null,null, preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.res"), null, TAB_LAIR],
065 : ["Lair: Witch", null,null, preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.res"), null, TAB_LAIR],
066 : ["Lair: Giant", null,null, preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.res"), null, TAB_LAIR],
067 : ["Lair: Fairy", null,null, preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.res"), null, TAB_LAIR],
068 : ["Lair: Thief", null,null, preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.res"), null, TAB_LAIR],
069 : ["Lair: Samurai", null,null, preload("res://edited_images/lair/creature_generic/anim0126/AnimLairGeneric.res"), null, TAB_LAIR],
070 : ["Lair: Horny", null,null, preload("res://edited_images/lair/creature_horny/anim0160/AnimLairHornedReaper.res"), null, TAB_LAIR],
071 : ["Lair: Skeleton", null,null, preload("res://edited_images/lair/creature_skeleton/anim0158/AnimLairSkeleton.res"), null, TAB_LAIR],
072 : ["Lair: Troll", null,null, preload("res://edited_images/lair/creature_generic/anim0156/r1frame01.png"), null, TAB_LAIR],
073 : ["Lair: Dragon", null,null, preload("res://edited_images/lair/creature_dragon/anim0154/AnimLairDragon.res"), null, TAB_LAIR],
...
075 : ["Lair: Fly", null,null, preload("res://edited_images/lair/creature_fly/anim0150/AnimLairFly.res"), null, TAB_LAIR],
076 : ["Lair: Mistress", null,null, preload("res://edited_images/lair/creature_dkmistress/anim0148/AnimLairMistress.res"), null, TAB_LAIR],
077 : ["Lair: Warlock", null,null, preload("res://edited_images/lair/creature_warlock/anim0146/AnimLairWarlock.res"), null, TAB_LAIR],
078 : ["Lair: Bile Demon", null,null, preload("res://edited_images/lair/creature_biledemon/anim0144/AnimLairBileDemon.res"), null, TAB_LAIR],
079 : ["Lair: Imp", null,null, preload("res://edited_images/lair/creature_dragon/anim0154/r1frame01.png"), null, TAB_LAIR],
080 : ["Lair: Beetle", null,null, preload("res://edited_images/lair/creature_bug/anim0142/AnimLairBeetle.res"), null, TAB_LAIR],
081 : ["Lair: Vampire", null,null, preload("res://edited_images/lair/creature_vampire/anim0140/r1frame01.png"), null, TAB_LAIR],
082 : ["Lair: Spider", null,null, preload("res://edited_images/lair/creature_spider/anim0138/AnimLairSpider.res"), null, TAB_LAIR],
...
094 : ["Box: Boulder Trap", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
095 : ["Box: Alarm Trap", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
096 : ["Box: Poison Gas Trap", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
097 : ["Box: Lightning Trap", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
098 : ["Box: Word of Power Trap", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
099 : ["Box: Lava Trap", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
100 : ["Box: Dummy Trap 2", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
101 : ["Box: Dummy Trap 3", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
102 : ["Box: Dummy Trap 4", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
103 : ["Box: Dummy Trap 5", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
104 : ["Box: Dummy Trap 6", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
105 : ["Box: Dummy Trap 7", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
106 : ["Box: Wooden Door", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
107 : ["Box: Braced Door", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
108 : ["Box: Iron Door", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
109 : ["Box: Magic Door", null,null, preload("res://dk_images/traps_doors/anim0116/AnimBox.res"), null, TAB_BOX],
110 : ["Workshop Item", null,null, preload("res://dk_images/furniture/workshop_anvil_tp/r1frame01.png"), null, TAB_MISC],
111 : ["Red Heart Flame", null,null, preload("res://dk_images/magic_fogs/anim0801/AnimRedHeartFlame.res"), null, TAB_FURNITURE],
112 : ["Disease Effect", null,null, null, null, TAB_MISC],
113 : ["Scavenger Eye", null,null, preload("res://dk_images/furniture/scavenge_eye_tp/AnimScavengerEye.res"), null, TAB_FURNITURE],
114 : ["Workshop Machine", null,null, preload("res://dk_images/furniture/workshop_machine_tp/AnimWorkshopMachine.res"), null, TAB_FURNITURE],
115 : ["Red Flag", null,null, preload("res://dk_images/furniture/flagpole_redflag_tp/AnimFlagpoleRed.res"), null, TAB_FURNITURE],
116 : ["Blue Flag", null,null, preload("res://dk_images/furniture/flagpole_blueflag_tp/AnimFlagpoleBlue.res"), null, TAB_FURNITURE],
117 : ["Green Flag", null,null, preload("res://dk_images/furniture/flagpole_greenflag_tp/AnimFlagpoleGreen.res"), null, TAB_FURNITURE],
118 : ["Yellow Flag", null,null, preload("res://dk_images/furniture/flagpole_yellowflag_tp/AnimFlagpoleYellow.res"), null, TAB_FURNITURE],
119 : ["Flagpole", null,null, preload("res://dk_images/furniture/flagpole_empty_tp/r1frame01.png"), null, TAB_FURNITURE],
120 : ["Blue Heart Flame", null,null, preload("res://dk_images/magic_fogs/anim0802/AnimBlueHeartFlame.res"), null, TAB_FURNITURE],
121 : ["Green Heart Flame", null,null, preload("res://dk_images/magic_fogs/anim0800/AnimGreenHeartFlame.res"), null, TAB_FURNITURE],
122 : ["Yellow Heart Flame", null,null, preload("res://dk_images/magic_fogs/anim0799/AnimYellowHeartFlame.res"), null, TAB_FURNITURE],
123 : ["Casted Sight", null,null, preload("res://dk_images/magic_fogs/anim0854/AnimCastedSight.res"), null, TAB_MISC],
...
127 : ["Power Hand Gold", null,null, preload("res://dk_images/power_hand/anim0782/AnimePowerHandGold.res"), null, TAB_MISC],
