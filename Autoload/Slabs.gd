...
var data = {
	...
	EARTH_WITH_TORCH:    ["Torch Earth",           BLOCK_SLAB, BITMASK_BLOCK,         PANEL_SIDE_VIEW, 4, TAB_OTHER,     WIBBLE_ON,       REMEMBER_PATH,  NOT_OWNABLE], # 3
	WALL_WITH_BANNER:    ["Banner Wall",           BLOCK_SLAB, BITMASK_REINFORCED,    PANEL_SIDE_VIEW, 4, TAB_OTHER,     WIBBLE_ON,       REMEMBER_PATH,  OWNABLE], # 4
	WALL_WITH_TORCH:     ["Torch Wall",            BLOCK_SLAB, BITMASK_REINFORCED,    PANEL_SIDE_VIEW, 4, TAB_OTHER,     WIBBLE_ON,       REMEMBER_PATH,  OWNABLE], # 5
